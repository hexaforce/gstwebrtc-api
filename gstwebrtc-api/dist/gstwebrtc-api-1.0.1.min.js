    ...
    347: (e) => {
      ...
      ;(t.localCName = t.generateIdentifier()),
        ...
        (t.parseCandidate = function (e) {
          ...
          const n = { foundation: t[0], component: { 1: 'rtp', 2: 'rtcp' }[t[1]] || t[1], protocol: t[2].toLowerCase(), priority: parseInt(t[3], 10), ip: t[4], address: t[4], port: parseInt(t[5], 10), type: t[7] }
        ...
        (t.parseExtmap = function (e) {
          ...
          return { id: parseInt(t[0], 10), direction: t[0].indexOf('/') > 0 ? t[0].split('/')[1] : 'sendrecv', uri: t[1], attributes: t.slice(2).join(' ') }
        }),
        ...
        (t.parseRtpParameters = function (e) {
          const n = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] },
        ...
        (t.writeRtpDescription = function (e, n) {
          ...
          ;(r += 'm=' + e + ' '),
            ...
            (r += n.codecs.map((e) => (void 0 !== e.preferredPayloadType ? e.preferredPayloadType : e.payloadType)).join(' ') + '\r\n'),
            (r += 'c=IN IP4 0.0.0.0\r\n'),
        ...
        (t.parseRtpEncodingParameters = function (e) {
          ...
          let c
          const l = t.matchPrefix(e, 'a=ssrc-group:FID').map((e) =>
            e
              .substring(17)
              .split(' ')
              .map((e) => parseInt(e, 10)),
          )
          l.length > 0 && l[0].length > 1 && l[0][0] === a && (c = l[0][1]),
            r.codecs.forEach((e) => {
              if ('RTX' === e.name.toUpperCase() && e.parameters.apt) {
                let t = { ssrc: a, codecPayloadType: parseInt(e.parameters.apt, 10) }
                a && c && (t.rtx = { ssrc: c }), n.push(t), i && ((t = JSON.parse(JSON.stringify(t))), (t.fec = { ssrc: a, mechanism: o ? 'red+ulpfec' : 'red' }), n.push(t))
              }
            }),
          ...
          return (
            d.length &&
              ((d = 0 === d[0].indexOf('b=TIAS:') ? parseInt(d[0].substring(7), 10) : 0 === d[0].indexOf('b=AS:') ? 1e3 * parseInt(d[0].substring(5), 10) * 0.95 - 16e3 : void 0),
              n.forEach((e) => {
                e.maxBitrate = d
              })),
            n
        ...
        (t.parseMsid = function (e) {
          ...
          if (1 === r.length) return (n = r[0].substring(7).split(' ')), { stream: n[0], track: n[1] }
          const i = t
            .matchPrefix(e, 'a=ssrc:')
            .map((e) => t.parseSsrcMedia(e))
            .filter((e) => 'msid' === e.attribute)
          return i.length > 0 ? ((n = i[0].value.split(' ')), { stream: n[0], track: n[1] }) : void 0
        }),
        ...
        (t.parseOLine = function (e) {
          ...
          return { username: n[0], sessionId: n[1], sessionVersion: parseInt(n[2], 10), netType: n[3], addressType: n[4], address: n[5] }
        }),
...
;(() => {
  n.d(r, { u: () => we, B: () => Oe })
  var e = {}
  n.r(e), n.d(e, { fixNegotiationNeeded: () => A, shimAddTrackRemoveTrack: () => R, shimAddTrackRemoveTrackWithNative: () => P, shimGetDisplayMedia: () => v, shimGetSendersWithDtmf: () => k, shimGetStats: () => T, shimGetUserMedia: () => y, shimMediaStream: () => b, shimOnTrack: () => S, shimPeerConnection: () => w, shimSenderReceiverGetStats: () => E })
  var t = {}
  n.r(t), n.d(t, { shimAddTransceiver: () => j, shimCreateAnswer: () => F, shimCreateOffer: () => U, shimGetDisplayMedia: () => I, shimGetParameters: () => N, shimGetUserMedia: () => x, shimOnTrack: () => O, shimPeerConnection: () => M, shimRTCDataChannel: () => H, shimReceiverGetStats: () => L, shimRemoveStream: () => G, shimSenderGetStats: () => D })
  var i = {}
  n.r(i), n.d(i, { shimAudioContext: () => Z, shimCallbacksAPI: () => W, shimConstraints: () => Y, shimCreateOfferLegacy: () => B, shimGetUserMedia: () => K, shimLocalStreamsAPI: () => z, shimRTCIceServerUrls: () => q, shimRemoteStreamsAPI: () => J, shimTrackEventTransceiver: () => V })
  var o = {}
  n.r(o), n.d(o, { removeExtmapAllowMixed: () => ie, shimAddIceCandidateNullOrEmpty: () => oe, shimConnectionState: () => re, shimMaxMessageSize: () => te, shimParameterlessSetLocalDescription: () => se, shimRTCIceCandidate: () => Q, shimRTCIceCandidateRelayProtocol: () => ee, shimSendThrowTypeError: () => ne })
  let s = !0,
    a = !0
  function c(e, t, n) {
    const r = e.match(t)
  ...
  function d(e) {
    return 'boolean' != typeof e ? new Error('Argument type: ' + typeof e + '. Please use a boolean.') : ((s = e), e ? 'adapter.js logging disabled' : 'adapter.js logging enabled')
  }
  function h(e) {
  ...
  function g(e, t, n) {
    ...
    return (
      ...
      o.forEach((t) => {
        e.forEach((n) => {
          n.type === r && n.trackId === t.id && f(e, n, i)
        })
      }),
      i
    )
      ...
      i = function (e, i) {
        ...
        if (e && 'object' == typeof e.video) {
          ...
          if (o && ('user' === o.exact || 'environment' === o.exact || 'user' === o.ideal || 'environment' === o.ideal) && (!n.mediaDevices.getSupportedConstraints || !n.mediaDevices.getSupportedConstraints().facingMode || s)) {
            let t
            if ((delete e.video.facingMode, 'environment' === o.exact || 'environment' === o.ideal ? (t = ['back', 'rear']) : ('user' !== o.exact && 'user' !== o.ideal) || (t = ['front']), t))
              return n.mediaDevices.enumerateDevices().then((n) => {
                ...
                return !s && n.length && t.includes('back') && (s = n[n.length - 1]), s && (e.video.deviceId = o.exact ? { exact: s.deviceId } : { ideal: s.deviceId }), (e.video = r(e.video)), C('chrome: ' + JSON.stringify(e)), i(e)
              })
          }
          e.video = r(e.video)
        }
        ...
        ('function' == typeof t
          ? (e.navigator.mediaDevices.getDisplayMedia = function (n) {
              return t(n).then((t) => {
                ...
                return (n.video = { mandatory: { chromeMediaSource: 'desktop', chromeMediaSourceId: t, maxFrameRate: o || 3 } }), r && (n.video.mandatory.maxWidth = r), i && (n.video.mandatory.maxHeight = i), e.navigator.mediaDevices.getUserMedia(n)
              })
            })
  ...
  function T(e) {
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      ...
      const i = function (e) {
          ...
          return (
            e.result().forEach((e) => {
              const n = { id: e.id, timestamp: e.timestamp, type: { localcandidate: 'local-candidate', remotecandidate: 'remote-candidate' }[e.type] || e.type }
              e.names().forEach((t) => {
                n[t] = e.stat(t)
              }),
                (t[n.id] = n)
  ...
  function E(e) {
    ...
    if (!('getStats' in e.RTCRtpReceiver.prototype)) {
      ...
      t &&
        ...
        l(e, 'track', (e) => ((e.receiver._pc = e.srcElement), e)),
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
        ...
        return (
          ...
          this.getReceivers().forEach((t) => (t.track === e && (n ? (r = !0) : (n = t)), t.track === e)),
  ...
  function M(e, t) {
    ...
    const n = { inboundrtp: 'inbound-rtp', outboundrtp: 'outbound-rtp', candidatepair: 'candidate-pair', localcandidate: 'local-candidate', remotecandidate: 'remote-candidate' },
  ...
  function K(e) {
    ...
    if (t.mediaDevices && t.mediaDevices.getUserMedia) {
      ...
      t.mediaDevices.getUserMedia = (e) => n(Y(e))
    }
    !t.getUserMedia &&
      t.mediaDevices &&
  ...
  function Y(e) {
    return e && void 0 !== e.video ? Object.assign({}, e, { video: _(e.video) }) : e
  }
  function q(e) {
    if (!e.RTCPeerConnection) return
  ...
  function Q(e) {
    ...
    ;(e.RTCIceCandidate = function (e) {
      ...
      l(e, 'icecandidate', (t) => (t.candidate && Object.defineProperty(t, 'candidate', { value: new e.RTCIceCandidate(t.candidate), writable: 'false' }), t))
  }
  function ee(e) {
    !e.RTCIceCandidate ||
      ...
      l(e, 'icecandidate', (e) => {
        if (e.candidate) {
          ...
          'relay' === t.type && (e.candidate.relayProtocol = { 0: 'tls', 1: 'tcp', 2: 'udp' }[t.priority >> 24])
        }
        return e
      })
  }
  ...
  !(function ({ window: n } = {}, r = { shimChrome: !0, shimFirefox: !0, shimSafari: !0 }) {
    const s = p,
      a = (function (e) {
        const t = { browser: null, version: null }
        if (void 0 === e || !e.navigator || !e.navigator.userAgent) return (t.browser = 'Not a browser.'), t
        const { navigator: n } = e
        if (n.mozGetUserMedia) (t.browser = 'firefox'), (t.version = c(n.userAgent, /Firefox\/(\d+)\./, 1))
        else if (n.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection)) (t.browser = 'chrome'), (t.version = c(n.userAgent, /Chrom(e|ium)\/(\d+)\./, 2))
        else {
          if (!e.RTCPeerConnection || !n.userAgent.match(/AppleWebKit\/(\d+)\./)) return (t.browser = 'Not a supported browser.'), t
          ;(t.browser = 'safari'), (t.version = c(n.userAgent, /AppleWebKit\/(\d+)\./, 1)), (t.supportsUnifiedPlan = e.RTCRtpTransceiver && 'currentDirection' in e.RTCRtpTransceiver.prototype)
        }
        return t
      })(n),
      l = { browserDetails: a, commonShim: o, extractVersion: c, disableLog: d, disableWarnings: h, sdp: $ }
    switch (a.browser) {
      case 'chrome':
        if (!e || !w || !r.shimChrome) return s('Chrome shim is not included in this adapter release.'), l
        if (null === a.version) return s('Chrome shim can not determine version, not shimming.'), l
        s('adapter.js shimming chrome.'), (l.browserShim = e), oe(n, a), se(n), y(n, a), b(n), w(n, a), S(n), R(n, a), k(n), T(n), E(n), A(n, a), Q(n), ee(n), re(n), te(n, a), ne(n), ie(n, a)
        break
      case 'firefox':
        if (!t || !M || !r.shimFirefox) return s('Firefox shim is not included in this adapter release.'), l
        s('adapter.js shimming firefox.'), (l.browserShim = t), oe(n, a), se(n), x(n, a), M(n, a), O(n), G(n), D(n), L(n), H(n), j(n), N(n), U(n), F(n), Q(n), re(n), te(n, a), ne(n)
        break
      case 'safari':
        if (!i || !r.shimSafari) return s('Safari shim is not included in this adapter release.'), l
        s('adapter.js shimming safari.'), (l.browserShim = i), oe(n, a), se(n), q(n), B(n), W(n), z(n), J(n), V(n), K(n), Z(n), Q(n), ee(n), te(n, a), ne(n), ie(n, a)
        break
      default:
        s('Unsupported browser!')
    }
  })({ window: 'undefined' == typeof window ? void 0 : window })
  const ae = Object.freeze({ meta: null, signalingServerUrl: 'ws://127.0.0.1:8443', reconnectionTimeout: 2500, webrtcConfig: { iceServers: [{ urls: ['stun:stun.l.google.com:19302', 'stun:stun1.l.google.com:19302'] }] } }),
    ce = Object.freeze({ idle: 0, connecting: 1, streaming: 2, closed: 3 })
  class le extends EventTarget {
    constructor(e, t) {
      super(), (this._peerId = e), (this._sessionId = ''), (this._comChannel = t), (this._state = ce.idle), (this._rtcPeerConnection = null)
    }
    get peerId() {
      return this._peerId
    }
  ...
  const de = Object.freeze({
    ...
    he = Object.freeze({ AltLeft: 'Alt_L', AltRight: 'Alt_R', ArrowDown: 'Down', ArrowLeft: 'Left', ArrowRight: 'Right', ArrowUp: 'Up', Backspace: 'BackSpace', CapsLock: 'Caps_Lock', ControlLeft: 'Control_L', ControlRight: 'Control_R', Enter: 'Return', HyperLeft: 'Hyper_L', HyperRight: 'Hyper_R', NumLock: 'Num_Lock', NumpadEnter: 'Return', MetaLeft: 'Meta_L', MetaRight: 'Meta_R', PageDown: 'Page_Down', PageUp: 'Page_Up', ScrollLock: 'Scroll_Lock', ShiftLeft: 'Shift_L', ShiftRight: 'Shift_R', SuperLeft: 'Super_L', SuperRight: 'Super_R' }),
    pe = new Set(['Clear', 'Copy', 'Cut', 'Delete', 'End', 'F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9', 'F10', 'F11', 'F12', 'Home', 'Insert', 'Paste', 'Redo', 'Tab', 'Undo'])
  function ue(e, t) {
    var n = 'Unidentified'
    if (1 === e.length) {
      const t = e.charCodeAt(0)
      t in de && (n = de[t])
    } else t in he ? (n = he[t]) : pe.has(t) && (n = t)
    return n
  }
  const me = Object.freeze(['wheel', 'contextmenu', 'mousemove', 'mousedown', 'mouseup', 'touchstart', 'touchend', 'touchmove', 'touchcancel', 'keyup', 'keydown']),
    _e = Object.freeze({ mousemove: 'MouseMove', mousedown: 'MouseButtonPress', mouseup: 'MouseButtonRelease' }),
    fe = Object.freeze({ touchstart: 'TouchDown', touchend: 'TouchUp', touchmove: 'TouchMotion', touchcancel: 'TouchUp' }),
    ge = Object.freeze({ keydown: 'KeyPress', keyup: 'KeyRelease' })
  function Ce(e) {
    const t = []
    return e.altKey && t.push('mod1-mask'), e.ctrlKey && t.push('control-mask'), e.metaKey && t.push('meta-mask'), e.shiftKey && t.push('shift-mask'), t.join('+')
  }
  class ye extends EventTarget {
      ...
      super(),
        ...
        e.addEventListener('error', (t) => {
          if (this._rtcDataChannel === e) {
            const e = t.error
            this.dispatchEvent(new ErrorEvent('error', { message: (e && e.message) || 'Remote controller error', error: e || new Error('unknown error on the remote controller data channel') }))
          }
        })
    }
    get rtcDataChannel() {
    ...
    attachVideoElement(e) {
      if (e instanceof HTMLVideoElement && e !== this._videoElement) {
        this._videoElement && this.attachVideoElement(null), (this._videoElement = e), (this._videoElementComputedStyle = window.getComputedStyle(e))
        for (const t of me) e.addEventListener(t, this)
        e.setAttribute('tabindex', '0')
      } else if (null === e && this._videoElement) {
        const e = this._videoElement
        e.removeAttribute('tabindex'), (this._videoElement = null), (this._videoElementComputedStyle = null), (this._lastTouchEventTimestamp = 0)
        for (const t of me) e.removeEventListener(t, this)
      }
    }
    close() {
      this.attachVideoElement(null)
      const e = this._rtcDataChannel
      ;(this._rtcDataChannel = null), e && (e.close(), this.dispatchEvent(new Event('closed')))
    }
    _sendGstNavigationEvent(e) {
      try {
        if (!e || 'object' != typeof e) throw new Error('invalid GstNavigation event')
        if (!this._rtcDataChannel) throw new Error('remote controller data channel is closed')
        this._rtcDataChannel.send(JSON.stringify(e))
      } catch (e) {
        this.dispatchEvent(new ErrorEvent('error', { message: `cannot send GstNavigation event over session ${this._consumerSession.sessionId} remote controller`, error: e }))
      }
    }
    _computeVideoMousePosition(e) {
      const t = { x: 0, y: 0 }
      if (!this._videoElement || this._videoElement.videoWidth <= 0 || this._videoElement.videoHeight <= 0) return t
      ...
      if ('offsetX' in e && 'offsetY' in e) (t.x = e.offsetX - n), (t.y = e.offsetY - i)
      else {
        const r = this._videoElement.getBoundingClientRect(),
          o = { left: parseFloat(this._videoElementComputedStyle.borderLeftWidth), top: parseFloat(this._videoElementComputedStyle.borderTopWidth) }
        ;(t.x = e.clientX - r.left - o.left - n), (t.y = e.clientY - r.top - o.top - i)
      }
      const s = { x: this._videoElement.clientWidth - (n + r), y: this._videoElement.clientHeight - (i + o) },
        a = Math.min(s.x / this._videoElement.videoWidth, s.y / this._videoElement.videoHeight)
      ;(s.x = Math.max(0.5 * (s.x - this._videoElement.videoWidth * a), 0)), (s.y = Math.max(0.5 * (s.y - this._videoElement.videoHeight * a), 0))
      const c = 0 !== a ? 1 / a : 0
      return (t.x = (t.x - s.x) * c), (t.y = (t.y - s.y) * c), (t.x = Math.min(Math.max(t.x, 0), this._videoElement.videoWidth)), (t.y = Math.min(Math.max(t.y, 0), this._videoElement.videoHeight)), t
    }
    handleEvent(e) {
        ...
        switch (e.type) {
          case 'wheel':
            e.preventDefault()
            {
              ...
              this._sendGstNavigationEvent({ event: 'MouseScroll', x: t.x, y: t.y, delta_x: -e.deltaX, delta_y: -e.deltaY, modifier_state: Ce(e) })
            }
            break
          case 'contextmenu':
            e.preventDefault()
          ...
          case 'mouseup':
            ...
            {
              const t = this._computeVideoMousePosition(e),
                n = { event: _e[e.type], x: t.x, y: t.y, modifier_state: Ce(e) }
              'mousemove' !== e.type && ((n.button = e.button + 1), 'mousedown' === e.type && 0 === e.button && this._videoElement.focus()), this._sendGstNavigationEvent(n)
            }
            break
          case 'touchstart':
          case 'touchend':
          ...
          case 'touchcancel':
            for (const t of e.changedTouches) {
              const n = this._computeVideoMousePosition(t),
                r = { event: fe[e.type], identifier: t.identifier, x: n.x, y: n.y, modifier_state: Ce(e) }
              !('force' in t) || ('touchstart' !== e.type && 'touchmove' !== e.type) || (r.pressure = t.force), this._sendGstNavigationEvent(r)
            }
            e.timeStamp > this._lastTouchEventTimestamp && ((this._lastTouchEventTimestamp = e.timeStamp), this._sendGstNavigationEvent({ event: 'TouchFrame', modifier_state: Ce(e) }))
            break
          case 'keyup':
          case 'keydown':
            e.preventDefault()
            {
              const t = { event: ge[e.type], key: ue(e.key, e.code), modifier_state: Ce(e) }
  ...
  class ve extends le {
    ...
    connect() {
      if (!this._comChannel || this._state === ce.closed) return !1
      if (this._state !== ce.idle) return !0
      const e = { type: 'startSession', peerId: this._peerId }
      return this._comChannel.send(e) ? ((this._state = ce.connecting), this.dispatchEvent(new Event('stateChanged')), !0) : (this.dispatchEvent(new ErrorEvent('error', { message: 'cannot connect consumer session', error: new Error('cannot send startSession message to signaling server') })), this.close(), !1)
    }
    onSessionStarted(e, t) {
      this._peerId !== e || this._state !== ce.connecting || this._sessionId || (this._sessionId = t)
    }
      ...
      if (this._state !== ce.closed && this._comChannel && this._sessionId) {
        if (!this._rtcPeerConnection) {
          ...
          ;(this._rtcPeerConnection = e),
            (e.ontrack = (t) => {
              if (this._rtcPeerConnection === e && t.streams && t.streams.length > 0) {
                this._state === ce.connecting && ((this._state = ce.streaming), this.dispatchEvent(new Event('stateChanged')))
                let e = !1
                for (const n of t.streams) this._streams.includes(n) || (this._streams.push(n), (e = !0))
            ...
            (e.onicecandidate = (t) => {
              this._rtcPeerConnection === e && t.candidate && this._comChannel && this._comChannel.send({ type: 'peer', sessionId: this._sessionId, ice: t.candidate.toJSON() })
            }),
        ...
        if (e.sdp)
          this._rtcPeerConnection
            ...
            .then((e) => (this._rtcPeerConnection && e ? this._rtcPeerConnection.setLocalDescription(e) : null))
            .then(() => {
              if (this._rtcPeerConnection && this._comChannel) {
                const e = { type: 'peer', sessionId: this._sessionId, sdp: this._rtcPeerConnection.localDescription.toJSON() }
                if (!this._comChannel.send(e)) throw new Error('cannot send local SDP configuration to WebRTC peer')
              }
            })
            .catch((e) => {
              this._state !== ce.closed && (this.dispatchEvent(new ErrorEvent('error', { message: 'an unrecoverable error occurred during SDP handshake', error: e })), this.close())
            })
        else {
          if (!e.ice) throw new Error(`invalid empty peer message received from consumer session ${this._sessionId}`)
          {
            const t = new RTCIceCandidate(e.ice)
            this._rtcPeerConnection.addIceCandidate(t).catch((e) => {
              this._state !== ce.closed && (this.dispatchEvent(new ErrorEvent('error', { message: 'an unrecoverable error occurred during ICE handshake', error: e })), this.close())
            })
          }
        }
      }
  ...
  class be extends le {
    constructor(e, t, n, r) {
      super(e, n), (this._sessionId = t), (this._state = ce.streaming)
      ...
      ;(i.onicecandidate = (e) => {
        this._rtcPeerConnection === i && e.candidate && this._comChannel && this._comChannel.send({ type: 'peer', sessionId: this._sessionId, ice: e.candidate.toJSON() })
      }),
        this.dispatchEvent(new Event('rtcPeerConnectionChanged')),
        i
          .setLocalDescription()
    ...
    onSessionPeerMessage(e) {
      if (this._state !== ce.closed && this._rtcPeerConnection)
        if (e.sdp)
          this._rtcPeerConnection.setRemoteDescription(e.sdp).catch((e) => {
            this._state !== ce.closed && (this.dispatchEvent(new ErrorEvent('error', { message: 'an unrecoverable error occurred during SDP handshake', error: e })), this.close())
          })
        else {
          if (!e.ice) throw new Error(`invalid empty peer message received from producer's client session ${this._peerId}`)
          {
            const t = new RTCIceCandidate(e.ice)
            this._rtcPeerConnection.addIceCandidate(t).catch((e) => {
              this._state !== ce.closed && (this.dispatchEvent(new ErrorEvent('error', { message: 'an unrecoverable error occurred during ICE handshake', error: e })), this.close())
  ...
  class Se extends EventTarget {
    constructor(e, t) {
      super(), (this._comChannel = e), (this._stream = t), (this._state = ce.idle), (this._clientSessions = {})
    }
    get stream() {
      return this._stream
    }
    ...
    start() {
      if (!this._comChannel || this._state === ce.closed) return !1
      if (this._state !== ce.idle) return !0
      const e = { type: 'setPeerStatus', roles: ['listener', 'producer'], meta: this._comChannel.meta }
      return this._comChannel.send(e) ? ((this._state = ce.connecting), this.dispatchEvent(new Event('stateChanged')), !0) : (this.dispatchEvent(new ErrorEvent('error', { message: 'cannot start producer session', error: new Error('cannot register producer to signaling server') })), this.close(), !1)
    }
    close() {
      if (this._state !== ce.closed) {
        for (const e of this._stream.getTracks()) e.stop()
        this._state !== ce.idle && this._comChannel && this._comChannel.send({ type: 'setPeerStatus', roles: ['listener'], meta: this._comChannel.meta }), (this._state = ce.closed), this.dispatchEvent(new Event('stateChanged')), (this._comChannel = null), (this._stream = null)
    ...
    onStartSessionMessage(e) {
      if (this._comChannel && this._stream && !(e.sessionId in this._clientSessions)) {
        const t = new be(e.peerId, e.sessionId, this._comChannel, this._stream)
        ;(this._clientSessions[e.sessionId] = t),
          t.addEventListener('closed', (e) => {
            const n = e.target.sessionId
            n in this._clientSessions && this._clientSessions[n] === t && (delete this._clientSessions[n], this.dispatchEvent(new CustomEvent('clientConsumerRemoved', { detail: t })))
          }),
          t.addEventListener('error', (e) => {
            this.dispatchEvent(new ErrorEvent('error', { message: `error from client consumer ${e.target.peerId}: ${e.message}`, error: e.error }))
          }),
          this.dispatchEvent(new CustomEvent('clientConsumerAdded', { detail: t }))
      }
    }
    onEndSessionMessage(e) {
      e.sessionId in this._clientSessions && this._clientSessions[e.sessionId].close()
    }
    onSessionPeerMessage(e) {
      e.sessionId in this._clientSessions && this._clientSessions[e.sessionId].onSessionPeerMessage(e)
    }
  }
  const ke = Object.freeze({ welcome: 'welcome', peerStatusChanged: 'peerStatusChanged', list: 'list', sessionStarted: 'sessionStarted', peer: 'peer', startSession: 'startSession', endSession: 'endSession', error: 'error' })
  function Te(e, t) {
    ...
    return n.id === t ? null : (e.meta && 'object' == typeof e.meta && (n.meta = e.meta), Object.freeze(n.meta), Object.freeze(n))
  }
  const Ee = WebSocket.prototype.send
  WebSocket.prototype.send = function (e) {
    console.log(`send >>> : ${e}`), Ee.call(this, e)
  }
  class Pe extends EventTarget {
    constructor(e, t, n) {
      super(),
        ...
        (this._ws.onerror = (e) => {
          this.dispatchEvent(new ErrorEvent('error', { message: e.message || 'WebSocket error', error: e.error || new Error(this._ready ? 'transportation error' : 'cannot connect to signaling server') })), this.close()
        }),
        (this._ws.onclose = () => {
            ...
            if (n && 'object' == typeof n)
              switch (n.type) {
                case ke.welcome:
                  ...
                  try {
                    this._ws.send(JSON.stringify({ type: 'setPeerStatus', roles: ['listener'], meta: t }))
                  } catch (e) {
                    this.dispatchEvent(new ErrorEvent('error', { message: 'cannot initialize connection to signaling server', error: e })), this.close()
                  }
                  break
                case ke.peerStatusChanged:
                  if (n.peerId === this._channelId) !this._ready && n.roles.includes('listener') && ((this._ready = !0), this.dispatchEvent(new Event('ready')), this.send({ type: 'list' })), this._producerSession && n.roles.includes('producer') && this._producerSession.onProducerRegistered()
                  else {
                    const e = Te(n, this._channelId)
                    e && (n.roles.includes('producer') ? this.dispatchEvent(new CustomEvent('producerAdded', { detail: e })) : this.dispatchEvent(new CustomEvent('producerRemoved', { detail: e })))
                  }
                  break
                case ke.list:
                  for (const e of n.producers) {
                    const t = Te(e, this._channelId)
                    t && this.dispatchEvent(new CustomEvent('producerAdded', { detail: t }))
                  }
                  break
                case ke.sessionStarted:
                  {
                    const e = this.getConsumerSession(n.peerId)
                    e && (delete this._consumerSessions[n.peerId], e.onSessionStarted(n.peerId, n.sessionId), e.sessionId && !(e.sessionId in this._consumerSessions) ? (this._consumerSessions[e.sessionId] = e) : e.close())
                  }
                  break
                case ke.peer:
                  {
                    const e = this.getConsumerSession(n.sessionId)
                    e ? e.onSessionPeerMessage(n) : this._producerSession && this._producerSession.onSessionPeerMessage(n)
                  }
                  break
                case ke.startSession:
                  this._producerSession && this._producerSession.onStartSessionMessage(n)
                  break
                case ke.endSession:
                  {
                    const e = this.getConsumerSession(n.sessionId)
                    e ? e.close() : this._producerSession && this._producerSession.onEndSessionMessage(n)
                  }
                  break
                case ke.error:
                  this.dispatchEvent(new ErrorEvent('error', { message: 'error received from signaling server', error: new Error(n.details) }))
                  break
                default:
    ...
    createProducerSession(e) {
      ...
      if (this._producerSession) return this._producerSession.stream === e ? this._producerSession : null
    ...
    createConsumerSession(e) {
      ...
      if (e in this._consumerSessions) return this._consumerSessions[e]
      for (const t of Object.values(this._consumerSessions)) if (t.peerId === e) return t
      const t = new ve(e, this)
      return (
        (this._consumerSessions[e] = t),
        t.addEventListener('closed', (e) => {
          let n = e.target.sessionId
          n || (n = e.target.peerId), n in this._consumerSessions && this._consumerSessions[n] === t && delete this._consumerSessions[n]
        }),
        t
      )
    }
    ...
    send(e) {
      if (this._ready && e && 'object' == typeof e)
        try {
          ...
          this.dispatchEvent(new ErrorEvent('error', { message: 'cannot send message to signaling server', error: e }))
        }
      return !1
    }
    close() {
  ...
  const Re = { config: null, channel: null, producers: {}, connectionListeners: [], producersListeners: [] }
  const we = Object.freeze({
    SessionState: ce,
    registerConnectionListener: function (e) {
      return !(!e || 'object' != typeof e || 'function' != typeof e.connected || 'function' != typeof e.disconnected) && (Re.connectionListeners.includes(e) || Re.connectionListeners.push(e), !0)
    },
    unregisterConnectionListener: function (e) {
      const t = Re.connectionListeners.indexOf(e)
      return t >= 0 && (Re.connectionListeners.splice(t, 1), !0)
    },
    unregisterAllConnectionListeners: function () {
      Re.connectionListeners = []
    },
    createProducerSession: function (e) {
      return Re.channel ? Re.channel.createProducerSession(e) : null
    },
    getAvailableProducers: function () {
      return Object.values(Re.producers)
    },
    registerProducersListener: function (e) {
      return !(!e || 'object' != typeof e || 'function' != typeof e.producerAdded || 'function' != typeof e.producerRemoved) && (Re.producersListeners.includes(e) || Re.producersListeners.push(e), !0)
    },
    unregisterProducersListener: function (e) {
      const t = Re.producersListeners.indexOf(e)
      return t >= 0 && (Re.producersListeners.splice(t, 1), !0)
    },
    unregisterAllProducersListeners: function () {
      Re.producersListeners = []
    },
    createConsumerSession: function (e) {
      return Re.channel ? Re.channel.createConsumerSession(e) : null
    },
  })
  function Ae() {
    for (const e of Re.connectionListeners)
      try {
        e.disconnected()
      } catch (e) {
        console.error('a listener callback should not throw any exception', e)
      }
  }
  function xe(e) {
    if (e in Re.producers) {
      const t = Re.producers[e]
      delete Re.producers[e]
      for (const e of Re.producersListeners)
        try {
          e.producerRemoved(t)
        } catch (e) {
          console.error('a listener callback should not throw any exception', e)
  ...
  function Ie() {
    if (Re.channel) {
      const e = Re.channel
      ;(Re.channel = null), e.close()
      for (const e in Re.producers) xe(e)
      ;(Re.producers = {}), Ae()
    }
    ;(Re.channel = new Pe(Re.config.signalingServerUrl, Re.config.meta, Re.config.webrtcConfig)),
      Re.channel.addEventListener('error', (e) => {
        e.target === Re.channel && console.error(e.message, e.error)
      }),
      Re.channel.addEventListener('closed', (e) => {
        if (e.target === Re.channel) {
          Re.channel = null
          for (const e in Re.producers) xe(e)
          ;(Re.producers = {}), Ae(), Re.config.reconnectionTimeout > 0 && window.setTimeout(Ie, Re.config.reconnectionTimeout)
        }
      }),
      Re.channel.addEventListener('ready', (e) => {
        e.target === Re.channel &&
          (function (e) {
            for (const t of Re.connectionListeners)
              try {
                t.connected(e)
              } catch (e) {
                console.error('a listener callback should not throw any exception', e)
              }
          })(Re.channel.channelId)
      }),
      Re.channel.addEventListener('producerAdded', (e) => {
        e.target === Re.channel &&
          (function (e) {
            if (!(e.id in Re.producers)) {
              Re.producers[e.id] = e
              for (const t of Re.producersListeners)
                try {
                  t.producerAdded(e)
                } catch (e) {
                  console.error('a listener callback should not throw any exception', e)
      ...
      Re.channel.addEventListener('producerRemoved', (e) => {
        e.target === Re.channel && xe(e.detail.id)
      })
  }
  function Oe(e) {
    if (Re.config) throw new Error('GstWebRTC API is already started')
    const t = Object.assign({}, ae)
    e && 'object' == typeof e && Object.assign(t, e), 'object' != typeof t.meta && (t.meta = null), (Re.config = t), Ie()
  }
  window.gstWebRTCAPI ||
    ((window.gstWebRTCAPI = we),
    window.addEventListener('DOMContentLoaded', () => {
      Oe(window.gstWebRTCConfig)
    }))
})()
var i = r.u,
  o = r.B
export { i as gstWebRTCAPI, o as start }
//# sourceMappingURL=gstwebrtc-api-1.0.1.min.js.map
